...
const auth_middlewere_1 = require("../../middleware/auth.middlewere");
const router = (0, express_1.Router)();
router.post("/register", (0, middleware_1.isValid)(authValidation.registerSchema), auth_service_1.default.register);
router.post("/verify-account", (0, auth_middlewere_1.isAuthenticated)(), auth_service_1.default.verifyAccount);
